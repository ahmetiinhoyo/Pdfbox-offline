...
export const en = {
    ...
    pagesTitle: "Edit Pages",
    pagesDesc: "Delete or reorder PDF pages, then download the result in one file.",
    pagesDropText: "Click or drop to select a PDF",
    pagesPage: (n) => `Page ${n}`,
    pagesSelected: (name, n) => `${name} · ${n} pages`,
    pagesRemaining: (n) => `${n} pages will remain`,
    pagesReset: "Reset",
    pagesNeedFile: "Pick a PDF first",
    pagesAllDeleted: "All pages deleted — at least one page must remain",
